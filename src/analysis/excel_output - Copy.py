...
from sort_results import sort_load_results 
from sort_results import sort_gen_results
from sort_results import sort_line_results
from sort_results import sort_trafo_results
from sort_results import sort_bus_results
...
def create_excel(network_name, scenario_name, net, results, gen_fuel_tech, number, column, parameters, output_path, time_steps):    
    ...
    if number['loads'] > 0:           
        ...
        load_table = sort_load_results(net, number, load_table, time_steps,results['load'])
